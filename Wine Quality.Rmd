...
```
Additionally, we can predict the influence of these variables on the wine quality.  for example,  The alcohol has highest impact on quality of wine such as 1 standard deviation change in the value of alcohol brings 0.477 standard deviation of change in wine quality.

# References:
[1] Field, A., Miles, J., and Field, Z. (2012). Discovering Statistics using R. Sage Publications.  
[2] https://www.mathworks.com/help/signal/ug/residual-analysis-with-autocorrelation.html

* Discussed the flow of analysis with peers in study group.
* Discussed regarding the what to do when assumptions of the test fails with professor.